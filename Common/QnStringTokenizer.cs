...
namespace SukiUiDemo.Common;
   ...
   /// </summary>
public readonly struct QnStringTokenizer : IEnumerable<StringSegment>
{
	...
	public QnStringTokenizer(string value, string separator)
	{
	...
	public QnStringTokenizer(StringSegment value, string separator)
	{
	...
	public struct Enumerator : IEnumerator<StringSegment>
	{
		...
		public Enumerator(ref QnStringTokenizer tokenizer)
		{
